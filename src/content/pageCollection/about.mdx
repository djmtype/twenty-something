...
<Callout variant="caution" title="Attention">Be sure to include a space after the colon in *slug*.</Callout>
...
In the top menu, select *File > Open Folder*, and select *twenty-something* folder from your device. 
